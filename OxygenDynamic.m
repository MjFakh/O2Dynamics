...
Weathering_pyrite_MC = 1500:100:2500;       % Range of pyrite weathering  
...
pCO2_half = 183.6;
pCO2_min = 10;
pCO2_1_MC = 100:100:1000;  % range of pCO2 during Phanerozoic (ppm)
...
NPP_MC = 10:10:100;  % Range of modern marine net primary production (grC/m2/yr)
...
O2  = interp1(pO2_interp,[O2_1(randi(numel(O2_1))) O2_2(randi(numel(O2_2))) O2_3(randi(numel(O2_3))) ...
                                               O2_4(randi(numel(O2_4))) O2_5(randi(numel(O2_5))) O2_6(randi(numel(O2_6))) ...
                                               O2_7(randi(numel(O2_7))) O2_8(randi(numel(O2_8)))],power_pO2); 

% -------------------- C_P ratio  -----------------------

C_P_oxic = 250;           % alcott et al. 2019 
C_P_anoxia = 1100;        % alcott et al. 2019 
C_P_modern = C_P_oxic;

C_P_1 = (C_P_oxic.*C_P_anoxia)./((O2./O2_modern).*C_P_anoxia + (1-(O2./O2_modern)).*C_P_oxic);

R_C_P = C_P_1./C_P_modern;
...
SO4_4 = [10 100 500];
SO4_5 = [100 500 1000];
SO4_6 = [1000 5000 10000];
SO4_7 = 30000;
SO4_8 = 30000;

SO4  = interp1(pO2_interp,[SO4_1(randi(numel(SO4_1))) SO4_2(randi(numel(SO4_2))) SO4_3(randi(numel(SO4_3))) ...
                                               SO4_4(randi(numel(SO4_4))) SO4_5(randi(numel(SO4_5))) SO4_6(randi(numel(SO4_6))) ...
                                               SO4_7(randi(numel(SO4_7))) SO4_8(randi(numel(SO4_8)))],power_pO2); 

km_SO4 = [10 50 100];

R_SO4 = SO4./(SO4 + km_SO4(randi(numel(km_SO4))));
...
f_anoxia  = interp1(pO2_interp,[f_anoxia_MC_1(randi(numel(f_anoxia_MC_1))) f_anoxia_MC_2(randi(numel(f_anoxia_MC_2))) f_anoxia_MC_3(randi(numel(f_anoxia_MC_3))) ...
...
BE  = interp1(pO2_interp,[BE_1(randi(numel(BE_1))) BE_2(randi(numel(BE_2))) BE_3(randi(numel(BE_3))) ...
...
fprod_1 = 0;
fprod_2 = 0.0005:0.0001:0.005;
fprod_3 = 0.001:0.001:0.01;
fprod_4 = 0.005:0.001:0.01;
fprod_5 = 0.007:0.001:0.02;
fprod_6 = 0.07:0.01:0.2;
fprod_7 = 1;
fprod_8 = 1;
...
fprod_1  = interp1(pO2_interp,[fprod_MC_1(randi(numel(fprod_MC_1))) fprod_MC_2(randi(numel(fprod_MC_2))) fprod_MC_3(randi(numel(fprod_MC_3))) ...
...
fprod = fprod_1.*R_SO4.*R_C_P;
NPP2 = NPP.* (BE_modern./BE);
NPP1 = NPP2;
F_anoxic_factor_1 = 0.01:0.01:0.1;
km_O2 = [0.5 1 2];
F_anoxic_factor_2 = 1-(O2./(O2 + km_O2(randi(numel(km_O2)))));
F_anoxic_factor = F_anoxic_factor_1(randi(numel(F_anoxic_factor_1))).*F_anoxic_factor_2;
F_anoxic = F_anoxic_factor.*(1-BE).* NPP1.* f_anoxia.*AREAtot;   % rate of marine oxygen sink

% --------- Marine Organic burial and Methane Production ------------

alpha_CH4_1 = 0.05:0.01:0.5;
...
F_volc_MC_2 = 1:1:5;
F_volc_MC_3 = 1:1:5;
F_volc_MC_4 = 0.5:0.1:2;
F_volc_MC_5 = 0.5:0.1:2;
F_volc_MC_6 = 0.5:0.1:2;
F_volc_MC_7 = 0.01:0.01:0.1;
F_volc_MC_8 = 0.01:0.01:0.1;
F_volc_MC_9 = 0.01:0.01:0.1;
...
medianline = movmean(medianline_1,100);
